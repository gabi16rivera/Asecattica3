<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmCentroCosto.aspx.cs" Inherits="ASECATTICA.AdmCentroCosto" %>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree o seleccione el centro de costo que considere necesario</li>
                        </ol>
                        <div class="row table table-responsive"> 
                        <asp:Button ID="BtnNuevo" class="breadcrumb-item" runat="server" Text="Agregar Centro de Costo" OnClick="BtnNuevo_Click" />
                            
                        <asp:GridView ID="GvCentroCosto" runat="server" AutoGenerateColumns="False" DataSourceID="DsCentroCosto" ViewStateMode="Enabled" ValidateRequestMode="Enabled" CellPadding="4" ForeColor="#333333" GridLines="None" Width="100%" OnSelectedIndexChanged="GvCentroCosto_SelectedIndexChanged">
                        ...
                        <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                               ...
                               <asp:SqlDataSource ID="DsCentroCosto" runat="server" ConnectionString="<%$ ConnectionStrings:bdAsecatticaConnectionString %>" SelectCommand="sp_crud_TBCentroCosto" SelectCommandType="StoredProcedure">
                                   <SelectParameters>
