<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AsociadoBeneficiarios.aspx.cs" Inherits="ASECATTICA.AsociadoBeneficiarios" %>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h1 class="mt-4">Beneficiario(a)</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">En esta sección podrá solicitar un cambio de beneficiarios que mantiene con la ASECATTICA</li>
                    </ol>
                    <div class="row">
                        <div class="col-md-1"></div>
                        <div class="col-md-10">
                            <div class="jumbotron">
                                <p class="lead">Por este medio solicita a la Asociación Solidarista de empleados de ASECATTICA a realizar los ajustes necesarios para establecer o cambiar mis beneficiarios.</p>
                                <p class="lead text-center"><b>Beneficiari(o) actual: APELLIDO APELLIDO NOMBRE, PARENTESCO, usuario@dominio.com, 8888-8888</b></p>
                                <hr class="my-4">
                                <p>Los datos del nuevo beneficiario son:</p>
                                <div class="row">
                                    ...
                                    <form class="form-horizontal" method="post">
                                        <fieldset>
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input id="fname" name="name" type="text" placeholder="Nombre completo" value="" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <span class="col-md-1 col-md-offset-2 text-center"><i class="fa fa-user bigicon"></i></span>
                                                <div class="col-md-12">
                                                    <input id="fname" name="name" type="text" placeholder="Parentesco" value="" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input id="email" name="email" type="text" placeholder="Correo electrónico" value="" class="form-control" >
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input id="phone" name="phone" type="text" placeholder="Teléfono" value="" class="form-control" >
                                                </div>
                                            </div>
