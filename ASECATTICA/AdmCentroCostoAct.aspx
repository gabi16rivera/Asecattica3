<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmCentroCostoAct.aspx.cs" Inherits="ASECATTICA.AdmCentroCostoAct" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta charset="utf-8" />
        ...
        <title>AdminCentroCostoAct</title>
...
<body class="sb-sidenav-toggled">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Centro de Costo</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree el centro de costo que considere necesario</li>
                        </ol>      
                    </div>
    ...
    CONTENIDO NORMAL DEL FORMULARIO-->
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCodigo">Código</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputTipo">Nombre</label>
                                            ...
                                            <asp:Button ID="BtnAgregar" runat="server" Text="Agregar" OnClick="BtnAgregar_Click" />
                                             <asp:Button ID="BtnAtrás" runat="server" Text="Atrás" OnClick="Atrás_Click" />
