<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmLineasCreditosAct.aspx.cs" Inherits="ASECATTICA.AdmLineasCreditosAct" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta charset="utf-8" />
        ...
        <title>AdminLineasCreditosAct</title>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree la línea de crédito que considere necesario</li>
                        </ol>      
                    </div>
...
<!--*****************************
    CONTENIDO NORMAL DEL FORMULARIO-->
                                            ...
                                            <div class="form-row" runat="server" >
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCodigoLineaCredito">Código de línea de crédito</label>
                                                    
                                                        <asp:TextBox ID="TxtCodigoLineaCredito"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="TxtNombre"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFechaUltAct">Fecha de última actualización</label>
                                                     
                                                        <asp:TextBox ID="TxtFechaUltAct"  runat="server" class="form-control py-4" TextMode="Date"></asp:TextBox>
                                                    </div>
                                                </div>

                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputPorcentajeInteres">Porcentaje de interés</label>
                                                     
                                                        <asp:TextBox ID="TxtPorcentajeInteres"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputTopeMaximo">Tope máximo</label>
                                                     
                                                        <asp:TextBox ID="TxtTopeMaximo"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div> <%--Fin del form-row--%>
