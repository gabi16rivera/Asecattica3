<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmUbicacionAct.aspx.cs" Inherits="ASECATTICA.AdmUbicacionAct" %>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree la ubicación que considere necesario</li>
                        </ol>      
                    </div>
                                            ...
                                            <div class="form-row" runat="server" >
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCodigoUbicacion">Código de Ubicación</label>
                                                    
                                                        <asp:TextBox ID="TxtCodigoUbicacion"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
