<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmAsientos.aspx.cs" Inherits="ASECATTICA.AdmAsientos" %>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="#.aspx">Actualizar</a>
                                </nav>
                            </div>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Asientos</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree o seleccione el asiento que considere necesario</li>
                        </ol>
                        <div class="row table table-responsive"> 
                        <asp:Button ID="BtnNuevo" class="breadcrumb-item" runat="server" Text="Agregar Asiento" OnClick="BtnNuevo_Click"/>
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="CodigoTipoAsiento" HeaderText="CodigoTipoAsiento" SortExpression="CodigoTipoAsiento" />
                        ...
                        <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
                            ...
                            <asp:SqlDataSource ID="DsAsientos" runat="server" ConnectionString="<%$ ConnectionStrings:bdAsecatticaConnectionString %>" SelectCommand="sp_crud_TBTipoAsiento" SelectCommandType="StoredProcedure">
                                <SelectParameters>
                                    <asp:Parameter DefaultValue="0" Name="CodigoTipoAsiento" Type="String" />
