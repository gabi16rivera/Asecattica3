<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmCreditosUsuAct.aspx.cs" Inherits="ASECATTICA.AdmCreditosUsuAct" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <meta charset="utf-8" />
        ...
        <title>AdminCreditoUsuAct</title>
...
<body class="sb-sidenav-toggled">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid">
                        <h1 class="mt-4">Crédito de Usuario</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree el crédito de usuario que considere necesario</li>
                        </ol>      
                    </div>
    ...
    CONTENIDO NORMAL DEL FORMULARIO-->
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCodigoCuenta">Codigo Cuenta</label>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputLineaCredito<">Linea de Crédito</label>
                                                        <asp:TextBox ID="TxtLineaCredito"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputUsuarioResponsable">Usuario Responsable</label>
                                                        <asp:TextBox ID="TxtUsuarioResponsable"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div> <%--Fin del form-row--%>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFechaInicio<">Fecha de Inicio</label>
                                                        <asp:TextBox ID="TxtFechaInicio"  runat="server" class="form-control py-4" TextMode="Date"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCuotasPactadas">Cuotas Pactadas</label>
                                                        <asp:TextBox ID="TxtCuotasPactadas"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div> <%--Fin del form-row--%>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCuotasPagar<">Cuotas a pagar</label>
                                                        <asp:TextBox ID="TxtCuotasPagar"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCuotasPendientes">Cuotas Pendientes</label>
                                                        <asp:TextBox ID="TxtCuotasPendientes"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div> <%--Fin del form-row--%>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputFechaFinal<">Fecha final</label>
                                                        <asp:TextBox ID="TxtFechaFinal"  runat="server" class="form-control py-4" TextMode="Date"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputAbonoCapital<">Abono a capital</label>
                                                        <asp:TextBox ID="TxtAbonoCapital"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputIntereses">Interéses</label>
                                                        <asp:TextBox ID="TxtIntereses"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div> <%--Fin del form-row--%>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputPrestamosNuevos<">Préstamos nuevos</label>
                                                        <asp:TextBox ID="TxtPrestamosNuevos"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
