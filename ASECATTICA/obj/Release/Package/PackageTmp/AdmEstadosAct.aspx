<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmEstadosAct.aspx.cs" Inherits="ASECATTICA.AdmEstadosAct" %>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree el estado que considere necesario</li>
                        </ol>      
                    </div>
                                            ...
                                            <div class="form-row" runat="server" >
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCodigoEstado">Código de Estado</label>
                                                    
                                                        <asp:TextBox ID="TxtCodigoEstado"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group">
