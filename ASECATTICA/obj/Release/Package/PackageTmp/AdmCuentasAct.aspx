<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmCuentasAct.aspx.cs" Inherits="ASECATTICA.AdmCuentasAct" %>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree la cuenta que considere necesario</li>
                        </ol>      
                    </div>
                                    ...
                                    <div class="card-body">
                                        <form runat="server">
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputNombreCuenta">Nombre Cuenta</label>
                                                        <asp:TextBox ID="TxtNombreCuenta"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="form-row">
                                               ...
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputSaldoAct">Saldo actual</label>
                                                        <asp:TextBox ID="TxtSaldoAct"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div> <%--Fin del form-row--%>
                                            ...
                                            <div class="form-row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputDebitosMes<">Débidos al mes</label>
                                                        <asp:TextBox ID="TxtDebitosMes"  runat="server" class="form-control py-4" TextMode="Date"></asp:TextBox>
                                                    </div>
                                                </div>
                                               <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="small mb-1" for="inputCreditosMes">Créditos al mes</label>
