<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AdmAsientosAct.aspx.cs" Inherits="ASECATTICA.AdmAsientosAct" %>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">En esta sección cree el asiento que considere necesario</li>
                        </ol>      
                    </div>
                                            ...
                                            <div class="form-row">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <asp:TextBox ID="TxtTipo"  runat="server" class="form-control py-4"></asp:TextBox>
                                                    </div>
                                                </div>
